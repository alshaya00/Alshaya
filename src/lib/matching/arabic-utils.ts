 ...
 * EXPANDED: Added more Gulf/Saudi Arabian names for better duplicate detection
 */
const NAME_VARIATIONS: Record<string, string[]> = {
  // محمد and its variations
  'محمد': ['محمد', 'حمد', 'حمود', 'حمدان', 'محمود', 'حميد', 'حامد', 'أحمد', 'مـحمد'],
  'أحمد': ['أحمد', 'احمد', 'حمد', 'أحمـد'],

  // عبدالله and compound variations (EXPANDED)
  'عبدالله': ['عبدالله', 'عبد الله', 'عبداللة', 'عبد اللة', 'عبداللـه', 'عبدالاه'],
  'عبدالرحمن': ['عبدالرحمن', 'عبد الرحمن', 'عبدالرحمان', 'عبد الرحمان', 'عبدالرحمـن'],
  'عبدالعزيز': ['عبدالعزيز', 'عبد العزيز', 'عبدالعزيـز'],
  'عبدالكريم': ['عبدالكريم', 'عبد الكريم'],
  'عبدالملك': ['عبدالملك', 'عبد الملك'],
  'عبدالمجيد': ['عبدالمجيد', 'عبد المجيد'],
  'عبدالمحسن': ['عبدالمحسن', 'عبد المحسن'],
  'عبداللطيف': ['عبداللطيف', 'عبد اللطيف'],
  'عبدالواحد': ['عبدالواحد', 'عبد الواحد'],
  'عبدالرزاق': ['عبدالرزاق', 'عبد الرزاق'],
  'عبدالحميد': ['عبدالحميد', 'عبد الحميد'],
  'عبدالسلام': ['عبدالسلام', 'عبد السلام'],
  'عبدالهادي': ['عبدالهادي', 'عبد الهادي'],
  'عبدالقادر': ['عبدالقادر', 'عبد القادر'],
  'عبدالحكيم': ['عبدالحكيم', 'عبد الحكيم'],

  // صالح variations
  'صالح': ['صالح', 'صلاح', 'صالـح'],

  // فهد variations
  'فهد': ['فهد', 'فهاد', 'فهـد'],

  // خالد variations
  'خالد': ['خالد', 'خلدون', 'مخلد', 'خالـد'],

  // سعود variations
  'سعود': ['سعود', 'سعد', 'سعيد', 'مسعود', 'سعـود'],

  // ناصر variations
  'ناصر': ['ناصر', 'نصر', 'منصور', 'نصار', 'ناصـر'],
  ...
  // إبراهيم variations (ADDED)
  'إبراهيم': ['إبراهيم', 'ابراهيم', 'براهيم', 'ابرهيم'],

  // سليمان variations (ADDED)
  'سليمان': ['سليمان', 'سلمان', 'سليـمان'],

  // عثمان variations (ADDED)
  'عثمان': ['عثمان', 'عثـمان'],

  // يوسف variations (ADDED)
  'يوسف': ['يوسف', 'يوسـف', 'يسف'],

  // موسى variations (ADDED)
  'موسى': ['موسى', 'موسا', 'مـوسى'],

  // سلطان variations (ADDED)
  'سلطان': ['سلطان', 'سلـطان'],

  // فارس variations (ADDED)
  'فارس': ['فارس', 'فرس', 'فارسي'],

  // علي variations (ADDED)
  'علي': ['علي', 'على', 'علـي'],

  // راشد variations (ADDED)
  'راشد': ['راشد', 'رشد', 'رشيد'],

  // ماجد variations (ADDED)
  'ماجد': ['ماجد', 'مجد', 'مـاجد'],

  // وليد variations (ADDED)
  'وليد': ['وليد', 'ولـيد'],

  // عمر variations (ADDED)
  'عمر': ['عمر', 'عـمر', 'عمير'],

  // طلال variations (ADDED)
  'طلال': ['طلال', 'طـلال'],

  // مشاري variations (ADDED)
  'مشاري': ['مشاري', 'مشارى', 'مشـاري'],

  // نايف variations (ADDED)
  'نايف': ['نايف', 'نائف', 'ناىف'],
  ...
  'فاطمة': ['فاطمة', 'فاطمه', 'فطوم', 'فطيمة', 'فاطـمة'],

  // سارة variations (female)
  'سارة': ['سارة', 'ساره', 'سارا', 'سـارة'],

  // لطيفة variations (female)
  'لطيفة': ['لطيفة', 'لطيفه', 'لطـيفة'],

  // منيرة variations (female)
  'منيرة': ['منيرة', 'منيره', 'منير', 'منـيرة'],

  // موضي variations (female - ADDED)
  'موضي': ['موضي', 'موضى', 'مضي'],

  // هيا variations (female - ADDED)
  'هيا': ['هيا', 'هياء', 'هيه'],

  // ريم variations (female - ADDED)
  'ريم': ['ريم', 'ريـم', 'رييم'],

  // عائشة variations (female - ADDED)
  'عائشة': ['عائشة', 'عايشة', 'عائشه', 'عايشه'],

  // خديجة variations (female - ADDED)
  'خديجة': ['خديجة', 'خديجه', 'خدوجة'],

  // مريم variations (female - ADDED)
  'مريم': ['مريم', 'مريـم'],

  // شيخة variations (female - ADDED)
  'شيخة': ['شيخة', 'شيخه', 'شيـخة'],

  // جواهر variations (female - ADDED)
  'جواهر': ['جواهر', 'جوهر', 'جواهـر'],
};
